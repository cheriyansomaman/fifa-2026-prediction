...
export function buildKO(results: Record<number, Result>): Fixture[] {
  ...
  const r32: Fixture[] = [
    { id: 101, home: 'Canada', away: 'South Africa', date: '2026-06-28T19:00:00Z', stage: 'r32', label: 'R32 #1', venue: '' },
    { id: 102, home: 'Germany', away: 'Paraguay', date: '2026-06-29T20:30:00Z', stage: 'r32', label: 'R32 #2', venue: '' },
    { id: 103, home: 'Brazil', away: 'Japan', date: '2026-06-29T17:00:00Z', stage: 'r32', label: 'R32 #3', venue: '' },
    { id: 104, home: 'Netherlands', away: 'Morocco', date: '2026-06-30T01:00:00Z', stage: 'r32', label: 'R32 #4', venue: '' },
    { id: 105, home: 'France', away: 'Sweden', date: '2026-06-30T21:00:00Z', stage: 'r32', label: 'R32 #5', venue: '' },
    { id: 106, home: 'Ivory Coast', away: 'Norway', date: '2026-06-30T17:00:00Z', stage: 'r32', label: 'R32 #6', venue: '' },
    { id: 107, home: 'Mexico', away: 'Ecuador', date: '2026-07-01T01:00:00Z', stage: 'r32', label: 'R32 #7', venue: '' },
    ...
    { id: 114, home: 'Colombia', away: 'Ghana', date: '2026-07-04T01:30:00Z', stage: 'r32', label: 'R32 #14', venue: '' },
    { id: 115, home: 'Argentina', away: 'Cape Verde', date: '2026-07-03T22:00:00Z', stage: 'r32', label: 'R32 #15', venue: '' },
    { id: 116, home: 'Australia', away: 'Egypt', date: '2026-07-03T22:00:00Z', stage: 'r32', label: 'R32 #16', venue: '' },
  ];
  allKO.push(...r32);

  const r16: Fixture[] = [
    { id: 201, home: winner(101), away: winner(104), date: '2026-07-04T17:00:00Z', stage: 'r16', label: 'R16 #1', venue: 'Houston' },
    { id: 202, home: winner(102), away: winner(105), date: '2026-07-04T21:00:00Z', stage: 'r16', label: 'R16 #2', venue: 'Philadelphia' },
    { id: 203, home: winner(109), away: winner(110), date: '2026-07-07T00:00:00Z', stage: 'r16', label: 'R16 #3', venue: 'Seattle' },
    { id: 204, home: winner(111), away: winner(112), date: '2026-07-06T19:00:00Z', stage: 'r16', label: 'R16 #4', venue: 'Arlington' },
    { id: 205, home: winner(103), away: winner(106), date: '2026-07-05T20:00:00Z', stage: 'r16', label: 'R16 #5', venue: 'East Rutherford' },
    { id: 206, home: winner(107), away: winner(108), date: '2026-07-06T00:00:00Z', stage: 'r16', label: 'R16 #6', venue: 'Mexico City' },
    { id: 207, home: winner(113), away: winner(114), date: '2026-07-07T20:00:00Z', stage: 'r16', label: 'R16 #7', venue: 'Vancouver' },
    { id: 208, home: winner(116), away: winner(115), date: '2026-07-07T16:00:00Z', stage: 'r16', label: 'R16 #8', venue: 'Atlanta' },
  ];
  allKO.push(...r16);
